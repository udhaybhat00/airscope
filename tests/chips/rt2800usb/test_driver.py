...
from airscope.chips.rt2800usb import SUPPORTED_IDS
from airscope.chips.rt2800usb.driver import RT2800USBDriver
...
def test_supported_channels_covers_2g_plus_5g_non_dfs():
    ...
    from airscope.chips.rt2800usb.chan import CHANNELS_5G_NON_DFS
...
def test_check_firmware_crc_accepts_valid_blob():
    ...
    from airscope.chips.rt2800usb.firmware import _crc_ccitt, check_firmware_crc
...
def test_bundled_rt5572_bin_passes_crc():
    ...
    from airscope.chips.rt2800usb.firmware import check_firmware_crc, load_firmware_blob
...
def test_set_field32_helper():
    ...
    from airscope.chips.rt2800usb.reg_init import _set_field32
...
def test_bbp_write_then_read_roundtrip():
    from airscope.chips.rt2800usb.bbp import bbp_read, bbp_write
    t = BbpFakeTransport()
    bbp_write(t, 65, 0x2C)
    bbp_write(t, 31, 0x08)
...
def test_bbp4_mac_if_ctrl_sets_bit_0x40():
    from airscope.chips.rt2800usb.bbp import bbp4_mac_if_ctrl, bbp_read, bbp_write
    t = BbpFakeTransport()
...
def test_init_bbp_53xx_rt5392_path():
    ...
    from airscope.chips.rt2800usb.bbp import bbp_read, init_bbp_53xx
    from airscope.chips.rt2800usb.constants import RT_RT5392
    t = BbpFakeTransport()
...
def test_init_bbp_53xx_rt5390_path_uses_different_106():
    from airscope.chips.rt2800usb.bbp import bbp_read, init_bbp_53xx
    from airscope.chips.rt2800usb.constants import RT_RT5390
    t = BbpFakeTransport()
...
def test_init_bbp_53xx_rejects_unsupported_silicon():
    import pytest
    from airscope.chips.rt2800usb.bbp import init_bbp_53xx
    from airscope.chips.rt2800usb.constants import RT_RT3572
    t = BbpFakeTransport()
...
def test_init_bbp_3572_lays_down_kernel_table():
    ...
    from airscope.chips.rt2800usb.bbp import bbp_read, init_bbp_3572
    t = BbpFakeTransport()
...
def test_init_bbp_dispatcher_routes_by_silicon():
    ...
    from airscope.chips.rt2800usb.bbp import bbp_read, init_bbp
    from airscope.chips.rt2800usb.constants import RT_RT3572, RT_RT5392
...
def test_disable_unused_dac_adc_noop_for_2t2r():
    ...
    from airscope.chips.rt2800usb.bbp import bbp_read, bbp_write, disable_unused_dac_adc
    t = BbpFakeTransport()
...
def test_rfcsr_write_then_read_roundtrip():
    from airscope.chips.rt2800usb.rfcsr import rfcsr_read, rfcsr_write
...
def test_init_rfcsr_5392_writes_full_table(monkeypatch):
    ...
    init table landed."""
    import airscope.chips.rt2800usb.rfcsr as rfm
...
def test_init_rfcsr_rejects_unsupported_silicon():
    import pytest
    from airscope.chips.rt2800usb.constants import RT_RT5390
    from airscope.chips.rt2800usb.rfcsr import init_rfcsr
    t = RfcsrFakeTransport()
...
def test_parse_rx_urb_decodes_trailer():
    ...
    from airscope.chips.rt2800usb.rx import parse_rx_urb
...
def test_rxwi_size_for_silicon():
    ...
    from airscope.chips.rt2800usb.rx import rxwi_size_for_silicon
...
def test_set_channel_rejects_out_of_range(monkeypatch):
    ...
    import pytest
    import airscope.chips.rt2800usb.chan as chan_mod
    from airscope.chips.rt2800usb.constants import RT_RT3572, RT_RT5392
    from airscope.chips.rt2800usb.rfcsr import RfFilterCal
...
def test_set_channel_3572_5g_synth_table_channel_36(monkeypatch):
    ...
    import airscope.chips.rt2800usb.chan as chan_mod
    from airscope.chips.rt2800usb.constants import RT_RT3572
    from airscope.chips.rt2800usb.rfcsr import RfFilterCal, rfcsr_read
    monkeypatch.setattr(chan_mod.time, "sleep", lambda *_a, **_kw: None)
...
def test_set_channel_3572_5g_rfcsr7_bits_set(monkeypatch):
    ...
    import airscope.chips.rt2800usb.chan as chan_mod
    from airscope.chips.rt2800usb.constants import RT_RT3572
    from airscope.chips.rt2800usb.rfcsr import RfFilterCal, rfcsr_read, rfcsr_write
    monkeypatch.setattr(chan_mod.time, "sleep", lambda *_a, **_kw: None)
    cal = RfFilterCal(calibration_bw20=0x10, calibration_bw40=0x15,
                      bbp25=0, bbp26=0)
...
def test_set_channel_3572_5g_gpio_ctrl_val7_clear(monkeypatch):
    ...
    import airscope.chips.rt2800usb.chan as chan_mod
    from airscope.chips.rt2800usb.constants import GPIO_CTRL, GPIO_CTRL_VAL7, RT_RT3572
    from airscope.chips.rt2800usb.rfcsr import RfFilterCal
    monkeypatch.setattr(chan_mod.time, "sleep", lambda *_a, **_kw: None)
    cal = RfFilterCal(calibration_bw20=0x10, calibration_bw40=0x15,
                      bbp25=0, bbp26=0)
...
def test_eeprom_nic_conf0_0x0f0f_treated_as_unburned():
    ...
    from airscope.chips.rt2800usb.eeprom import parse_eeprom
    buf = bytearray(0x200)
...
def test_eeprom_rf_type_decodes_nic_conf0_bits_11_8():
    ...
    from airscope.chips.rt2800usb.eeprom import RF3052, parse_eeprom
    buf = bytearray(0x200)
...
def test_resolve_rf_chip_rt3572_burned_is_rf3052_ported():
    from airscope.chips.rt2800usb.eeprom import RF3052, parse_eeprom, resolve_rf_chip
    buf = bytearray(0x200)
    buf[0x34] = 0x22   # 2T2R
...
def test_resolve_rf_chip_rt3572_unburned_gives_zero_not_fail():
    ...
    from airscope.chips.rt2800usb.eeprom import parse_eeprom, resolve_rf_chip
...
def test_resolve_rf_chip_rt5392_reads_chip_id_word():
    ...
    from airscope.chips.rt2800usb.eeprom import RF5392, parse_eeprom, resolve_rf_chip
    buf = bytearray(0x200)
...
def test_resolve_rf_chip_rt5592_hardcoded_rf5592():
    ...
    from airscope.chips.rt2800usb.eeprom import RF5592, parse_eeprom, resolve_rf_chip
...
def test_resolve_rf_chip_unknown_rf_marked_unported():
    ...
    from airscope.chips.rt2800usb.eeprom import RF3022, parse_eeprom, resolve_rf_chip
    buf = bytearray(0x200)
    buf[0x34] = 0x22   # 2T2R
...
def test_set_channel_writes_rfcsr8_for_channel_1(monkeypatch):
    ...
    import airscope.chips.rt2800usb.chan as chan_mod
    from airscope.chips.rt2800usb.constants import RT_RT5392
    from airscope.chips.rt2800usb.rfcsr import rfcsr_read
    monkeypatch.setattr(chan_mod.time, "sleep", lambda *_a, **_kw: None)
...
def test_build_tx_descriptors_default_shape():
    ...
    PACKETID_ENTRY = 2."""
    import struct
    from airscope.chips.rt2800usb.tx import build_tx_descriptors
...
def test_build_tx_descriptors_phymode_matches_rt5572_capture():
    ...
    from airscope.chips.rt2800usb.constants import TXWI_PHYMODE_CCK, TXWI_PHYMODE_OFDM
    from airscope.chips.rt2800usb.tx import build_tx_descriptors
...
def test_txwi_size_for_silicon():
    from airscope.chips.rt2800usb.constants import RT_RT3572, RT_RT5392, RT_RT5592
    from airscope.chips.rt2800usb.tx import txwi_size_for_silicon
...
def test_build_deauth_structure():
    from airscope.chips.rt2800usb.tx import BROADCAST_MAC, build_deauth
...
def test_init_bbp_dispatcher_routes_5592(monkeypatch):
    ...
    import airscope.chips.rt2800usb.bbp as bbp_mod
...
def test_init_bbp_5592_rev_5592c_extra_writes(monkeypatch):
    ...
    import airscope.chips.rt2800usb.bbp as bbp_mod
    from airscope.chips.rt2800usb.constants import REV_RT5592C
    monkeypatch.setattr(bbp_mod.time, "sleep", lambda *_a, **_kw: None)
...
def test_is_xtal_40mhz_reads_mac_debug_index_bit():
    ...
    from airscope.chips.rt2800usb.constants import MAC_DEBUG_INDEX
...
def test_iq_calibration_picks_correct_band_for_channel():
    ...
    from airscope.chips.rt2800usb.eeprom import IqCalibration
    iq = IqCalibration(
...
def test_iq_calibrate_writes_bbp158_159_pairs():
    ...
    import airscope.chips.rt2800usb.bbp as bbp_mod
    from airscope.chips.rt2800usb.chan import iq_calibrate
    from airscope.chips.rt2800usb.eeprom import IqCalChannel
...
def test_txpower_to_dev_clamps_per_band():
    ...
    from airscope.chips.rt2800usb.eeprom import txpower_to_dev
...
def test_default_power_2g_from_bg_tables():
    ...
    import airscope.chips.rt2800usb.chan as chan
...
def test_config_txpower_byrate_min_0xc():
    ...
    import airscope.chips.rt2800usb.chan as chan
    from airscope.chips.rt2800usb.bbp import bbp_read
    from airscope.chips.rt2800usb.constants import TX_PWR_CFG_0
