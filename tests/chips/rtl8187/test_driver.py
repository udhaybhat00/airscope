...
from airscope.chips.rtl8187 import SUPPORTED_IDS
...
def _read_rx_conf(t) -> int:
    from airscope.chips.rtl8187.constants import REG_RX_CONF
...
def test_start_writes_station_baseline_no_monitor(monkeypatch):
    ...
    import airscope.chips.rtl8187.mac as mac
    from airscope.chips.rtl8187.constants import RX_CONF_MONITOR
...
def test_configure_filter_enters_monitor_with_ctrl(monkeypatch):
    ...
    import airscope.chips.rtl8187.mac as mac
    from airscope.chips.rtl8187.constants import RX_CONF_CTRL, RX_CONF_MONITOR
...
def test_parse_rx_urb_decodes_trailer_and_strips_fcs():
    from airscope.chips.rtl8187.rx import parse_rx_urb
...
# ----------------------------------------------------------------------
def _zero_power():
    from airscope.chips.rtl8187.rtl8225 import TxPower
    return TxPower(hw_value=tuple([0] * 14), base=0)


def test_config_channel_rejects_out_of_range(monkeypatch):
    from airscope.chips.rtl8187 import chan as chan_mod
    from airscope.chips.rtl8187.rtl8225 import RfVariant
    import pytest
...
def test_config_channel_writes_correct_rf7_word(monkeypatch):
    ...
    from airscope.chips.rtl8187 import chan as chan_mod
    from airscope.chips.rtl8187.rtl8225 import RfVariant, rtl8225_chan
...
def test_build_tx_hdr_default_shape():
    from airscope.chips.rtl8187.tx import TX_HDR_SIZE, build_tx_hdr
    import struct
...
def test_build_tx_hdr_rate_index_lands_in_bits_24_27():
    from airscope.chips.rtl8187.tx import RATE_24MBPS_OFDM, build_tx_hdr
    import struct
...
def test_build_tx_hdr_rejects_oversized_frame():
    from airscope.chips.rtl8187.tx import build_tx_hdr
    import pytest
...
def test_stamp_seq_ctrl_increments_and_preserves_frag():
    ...
    from airscope.chips.rtl8187.tx import stamp_seq_ctrl
...
def test_build_deauth_unicast_sets_ack_nav():
    ...
    from airscope.chips.rtl8187.tx import build_deauth
...
def test_config_channel_dispatches_z2_set_tx_power(monkeypatch):
    ...
    from airscope.chips.rtl8187 import chan as chan_mod
    import airscope.chips.rtl8187.rtl8225 as rf
    from airscope.chips.rtl8187.rtl8225 import RfVariant
...
def test_z2_set_tx_power_uses_eeprom_cck_ofdm_gain(monkeypatch):
    ...
    import airscope.chips.rtl8187.rtl8225 as rf
    from airscope.chips.rtl8187.constants import REG_TX_GAIN_CCK, REG_TX_GAIN_OFDM
    from airscope.chips.rtl8187.rtl8225 import RfVariant, TxPower, set_tx_power
