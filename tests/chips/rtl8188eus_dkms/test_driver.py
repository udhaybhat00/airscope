...
"""
from airscope.chips.rtl8188eus_dkms import SUPPORTED_IDS, chan, driver as drv_mod
from airscope.chips.rtl8188eus_dkms.constants import PID, VID
...
def test_manager_registration_and_env_order(monkeypatch):
    ...
    monkeypatch.delenv("AIRSCOPE_RTL8188", raising=False)
    assert selected() is Rtl8188eusDkmsDriver     # default: vendor/DKMS port for 2357:010c (stress-stable)

    monkeypatch.setenv("AIRSCOPE_RTL8188", "mainline")
