"""Unit tests for the pure helpers in airscope.setup.windows.
...
from airscope.setup.windows import (
    _LIBUSB_SERVICES,
    _PNPUTIL_OK,
    _build_args,
    _restore_command,
...
def test_build_args_dest_appends_absolute_extraction_dir():
    ...
    args = _build_args(0x0BDA, 0x8187, dest=r"C:\Temp\airscope_winusb")
    assert args[args.index("--dest") + 1] == r"C:\Temp\airscope_winusb"
