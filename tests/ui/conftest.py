...
def _isolate_config(tmp_path, monkeypatch):
    """UI tests build AirscopeApp, which loads and persists Config: keep that off the real on-disk
    ...
    Config.theme = "airscope-green-dark"
...
@pytest.fixture
def no_usb_devices():
    """Bus scan finds zero cards, so booting AirscopeApp touches no real backend.
