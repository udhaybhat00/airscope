...
def initial_config(t: RT5370Transport, chip: ChipInfo, ev: EepromValues) -> None:
...
def enable_monitor(t: RT5370Transport, chip: ChipInfo, ev: EepromValues, drv=None) -> None:
    ...
    (RT5390 has no init-derived calibration)."""
