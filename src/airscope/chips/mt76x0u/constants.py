...
from airscope.chips.products import ALFA, ASUS, AVM, AboCom, Comcast, DLink, Devolo, Edimax, IODATA, Linksys, Planex, Sitecom, TPLink, TRENDnet, Zyxel
...
# 802.11 channel-width enum (subset; only what airscope cares about).
