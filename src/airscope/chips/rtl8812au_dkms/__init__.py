...
driver (A/B-proven on hardware); ``AIRSCOPE_RTL8812=mainline`` falls back to the mainline
...
cold-boot bring-up is verified **byte-for-byte** against vendor's 8812au USB captures
...
from airscope.chips.products import ALFA, ASUS, AboCom, AmpedWireless, Belkin, Buffalo, DLink, Edimax, EnGenius, Hawking, IODATA, Linksys, Logitec, NEC, Netgear, Planex, Sitecom, TPLink, TRENDnet, Tenda, WD, WistronNeWeb, Zyxel
