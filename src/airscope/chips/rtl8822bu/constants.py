...
:mod:`airscope.chips.rtw88_base.registers` and adds the 8822b-specific bits.
"""
...
from airscope.chips.products import ASUS, Buffalo, CCandC, DLink, Edimax, Elecom, Hawking, Linksys, LiteOn, Mercusys, Netgear, TPLink, TRENDnet
