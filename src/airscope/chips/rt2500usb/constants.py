...
from airscope.chips.products import ASUS, Belkin, Buffalo, DLink, Gigabyte, Hercules, Linksys, MSI, NovaTech, Ralink, Sagem, Siemens, Spairon, SureCom, VTech, Zinwell
