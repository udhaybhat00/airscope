...
from :mod:`airscope.chips.rtw88_base.registers` and adds the 8814a-specific
...
from airscope.chips.rtw88_base.registers import (  # noqa: F401
    BIT_CHECK_SUM_OK,
...
from airscope.chips.products import ALFA, ASUS, DLink, Edimax, Elecom, Hawking, Netgear, TPLink, TRENDnet
...
from airscope.chips.rtw88_base.registers import (  # noqa: E402,F401
    REG_FIFOPAGE_CTRL_2,
    REG_FIFOPAGE_INFO_1,
    REG_FWHW_TXQ_CTRL,
    REG_RQPN_CTRL_2,
