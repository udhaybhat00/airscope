"""RTL8814AU register map and magic numbers — vendor (vendor 8814au 5.8.5.1) port.
...
# airscope is always-monitor, so connect() runs the vendor's monitor opmode entry
