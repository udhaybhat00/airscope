...
Cleanroom re-port of the RTL8821AU / RTL8811AU (ALFA AWUS036ACS, `0bda:0811`) from contributor's [PR #194](https://github.com/vendor/8821au-20210708/pull/194) to the
`vendor/8821au-20210708` 5.12.5.2 vendor source; the DKMS out-of-tree `rtl88xxau` driver (Realtek
...
ordered by `$AIRSCOPE_RTL8821` read fresh per run (flips between runs without a restart). This DKMS
...
**TX power collapses to the PG base.** The contributor Makefile sets `CONFIG_TXPWR_BY_RATE_EN=0` /
