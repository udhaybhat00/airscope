...
Cleanroom re-port from the contributor ``8821au-20210708`` 5.12.5.2 vendor source
...
0bda:0811 and are ordered by ``$AIRSCOPE_RTL8821`` (DKMS default, ``=mainline``
...
from airscope.chips.products import ALFA, Buffalo, DLink, Edimax, Elecom, Hawking, IODATA, Netgear, Obihai, Planex, TPLink
