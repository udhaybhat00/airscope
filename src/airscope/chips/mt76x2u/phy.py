...
class Mt76x2CalState:
    """Mirror of the subset of kernel ``mt76x02_dev.cal`` that airscope
...
def update_channel_gain(
    ...
    *,
    ...
    The periodic RX gain adapt loop. Kernel runs this every ~1 s. Airscope
...
def edcca_init(transport: MT76x2UTransport) -> None:
    """`mt76x02_edcca_init` — [SRC] mt76x02_mac.c:1100. Airscope takes the
