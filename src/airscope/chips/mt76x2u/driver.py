...
class MT76x2UDriver(Driver):
    ...
    def __init__(self, dev: usb.core.Device, id_entry: DeviceID):
        ...
        # Regulatory TX power cap. Kernel reads from cfg80211; airscope has no
        ...
        # ``AIRSCOPE_MT76X2U_SET_TXPOWER=0`` skips the kernel's
        ...
        env_setpwr = os.environ.get(
            "AIRSCOPE_MT76X2U_SET_TXPOWER", "1"
        ).strip()
    ...
    async def connect(self, progress_cb: Optional[ProgressCallback] = None) -> bool:
        ...
        # trusts the EEPROM (kernel behavior); ``AIRSCOPE_MT76X2U_TSSI=0`` is a
        ...
        try:
            ...
            eeprom_tssi = False
        env_tssi = os.environ.get("AIRSCOPE_MT76X2U_TSSI", "").strip()
