...
THEME_BARS_PRIMARY_KEY   = "airscope-logo-bars-primary"
THEME_BARS_SECONDARY_KEY = "airscope-logo-bars-secondary"
THEME_TEXT_PRIMARY_KEY   = "airscope-logo-text-primary"
THEME_TEXT_SECONDARY_KEY = "airscope-logo-text-secondary"
...
_LOGO_DARK_DEFAULTS = {
    THEME_BARS_PRIMARY_KEY:   "#7df0c4",
    THEME_BARS_SECONDARY_KEY: "#2a7a5c",
    THEME_TEXT_PRIMARY_KEY:   "#e8edf3",
    THEME_TEXT_SECONDARY_KEY: "#5b6472",
}
