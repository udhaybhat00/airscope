...
from airscope.dot11 import random_client_mac, str_to_mac
from airscope.wlan.lease import SPOOFABLE
...
from airscope.campaigns.wep.chopchop import WepChopChop
