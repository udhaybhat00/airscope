...
the bring-up engine, dispatched by :class:`airscope.setup.base.Setup`: WinUSB bind/unbind on Windows,
...
class SetupTarget:
    """One opt-in unit for the Zadig-style "hand airscope this chipset" flow.
...
def target_for_vidpid(vid: int, pid: int) -> SetupTarget | None:
    ...
    """
    from airscope.device.manager import driver_for, supported_ids
